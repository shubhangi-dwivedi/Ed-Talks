package com.example.ed_talk.AddInterviewExperience;
...
import com.example.ed_talk.AddInterviewExperience.UploadImage;
            ...
            public void onClick(View view) {
                ...
                if(flag==1) {
                    if (isInternshipReview == true)
                        mMessagesDatabaseReference = FirebaseDatabase.getInstance().getReference().child("experience").child("Internships");
                    else
                        mMessagesDatabaseReference = FirebaseDatabase.getInstance().getReference().child("experience").child("Placements");
